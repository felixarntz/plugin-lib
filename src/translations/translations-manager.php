...
class Translations_Manager extends Translations {
	...
	protected function init() {
		$this->translations = array(
			...
			'rest_item_date_description'                            => $this->__translate( 'The date the object was created.', 'textdomain' ),
			'rest_item_date_date_modified_description'              => $this->__translate( 'The date the object was last modified.', 'textdomain' ),
