...
if ( ! class_exists( 'Leaves_And_Love\Plugin_Lib\MVC\Model_Type_Managers\Post_Type_Manager' ) ) :
...
class Post_Type_Manager extends Core_Model_Type_Manager {
	...
	public function __construct( $prefix ) {
		...
		$this->model_type_class_name = 'Leaves_And_Love\Plugin_Lib\MVC\Model_Types\Post_Type';
	}
