...
namespace Leaves_And_Love\Plugin_Lib\MVC\Model_Type_Managers;

use Leaves_And_Love\Plugin_Lib\MVC\Model_Type_Manager;

if ( ! class_exists( 'Leaves_And_Love\Plugin_Lib\MVC\Model_Type_Managers\Core_Model_Type_Manager' ) ) :
...
abstract class Core_Model_Type_Manager extends Model_Type_Manager {
	...
	public function __construct( $prefix ) {
		...
		$this->model_type_class_name = 'Leaves_And_Love\Plugin_Lib\MVC\Model_Types\Core_Model_Type';
	}
