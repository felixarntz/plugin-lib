...
namespace Leaves_And_Love\Plugin_Lib\MVC\Queries;

use Leaves_And_Love\Plugin_Lib\MVC\Query;

if ( ! class_exists( 'Leaves_And_Love\Plugin_Lib\MVC\Queries\Core_Query' ) ) :
...
abstract class Core_Query extends Query {
	 ...
	 * @access public
	 *
	 * @param Leaves_And_Love\Plugin_Lib\MVC\Managers\Core_Manager $manager The manager instance for the model query.
	 */
	 ...
	 * @return Leaves_And_Love\Plugin_Lib\MVC\Collections\Core_Collection Collection of models.
	 */
	 ...
	 * @access protected
	 *
	 * @return Leaves_And_Love\Plugin_Lib\MVC\Collections\Core_Collection Results as a collection.
	 */
