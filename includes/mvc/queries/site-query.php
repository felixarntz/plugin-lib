...
if ( ! class_exists( 'Leaves_And_Love\Plugin_Lib\MVC\Queries\Site_Query' ) ) :
...
class Site_Query extends Core_Query {
	 ...
	 * @return Leaves_And_Love\Plugin_Lib\MVC\Collections\Site_Collection Collection of sites.
	 */
	 ...
	 * @access protected
	 *
	 * @return Leaves_And_Love\Plugin_Lib\MVC\Collections\Site_Collection Results as a collection.
	 */
